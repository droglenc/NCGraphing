...
FSA::purl2(file.path(here::here(),"modules/Means",paste0(fnm,".Rmd")),
           moreItems=c("source","setwd","fnm","opts_chunk","flipbookr","patchwork","head",
...
`r chunk_reveal("edv1",break_type="auto",split=splitPerc)`
...
`r chunk_reveal("edv2",break_type="auto",split=splitPerc)`
...
`r chunk_reveal("mnsbar1",break_type="user",split=splitPerc)`
...
`r chunk_reveal("mnspts1",break_type="user",split=splitPerc)`
...
`r chunk_reveal("mnsbar2",break_type="user",split=splitPerc)`
...
`r chunk_reveal("mnspts2",break_type="user",split=splitPerc)`
...
`r chunk_reveal("mnspts3",break_type="non_seq",split=splitPerc)`
...
`r chunk_reveal("mnvio",break_type="user",split=splitPerc)`
...
`r chunk_reveal("mnspts4",break_type="non_seq",split=splitPerc)`
...
`r chunk_reveal("mnspts5",break_type="user",split=splitPerc)`
...
`r chunk_reveal("sum2",break_type="user",left_assign=leftAssign,split=40)`
...
head(select(sum2,lake,n,mean,lci,uci))
...
`r chunk_reveal("mnsbar6",break_type="user",split=splitPerc)`
...
`r chunk_reveal("mnspts6",break_type="user",split=splitPerc)`
...
<font size="7">We will discuss how to add smoothers and model results to a scatterplot.</font>
