...
This is the same data set [introduced here](../intro/CE_Loons.html) (which include code for accessing the data). If you did those exercises, then you can use the same data and package (e.g., `ggplot2` or `tidyverse`) loading portion of your script.
