...
knitr::include_graphics("blackbear.jpg")
```
...
- Variables are:
  - **DATE**: Dateo of capture (*won't be used here*).
...
`r chunk_reveal("hist1",break_type="auto",left_assign=TRUE,split=50)`
...
`r chunk_reveal("hist2",break_type="non_seq",left_assign=TRUE,split=50)`
...
`r chunk_reveal("hist3",break_type="user",left_assign=TRUE,split=50)`
...
`r chunk_reveal("histsplit1",break_type="non_seq",left_assign=TRUE,split=50)`
...
`r chunk_reveal("histsplit2",break_type="user",left_assign=TRUE,split=50)`
...
`r chunk_reveal("density1",break_type="non_seq",left_assign=TRUE,split=50)`
...
`r chunk_reveal("densitysplit1",break_type="non_seq",left_assign=TRUE,split=50)`
...
`r chunk_reveal("boxplot1",break_type="auto",left_assign=TRUE,split=50)`
...
`r chunk_reveal("boxplot2",break_type="auto",left_assign=TRUE,split=50)`
...
`r chunk_reveal("violin2",break_type="user",left_assign=TRUE,split=50)`
