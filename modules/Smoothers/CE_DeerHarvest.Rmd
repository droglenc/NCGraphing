...
## Antlerless Bow vs Gun Harvest 1
...
## Anlerless Bow vs Gun Harvest 2
Construct `ggplot2` code to match the graph below (as closely as you can).
...
## Antlerless Bow vs Gun Harvest by County 1
Construct `ggplot2` code to match the graph below (as closely as you can).
...
## Total Harvest of Antlered vs Antlerless
Construct `ggplot2` code to match the graph below (as closely as you can).

```{r AA_1, fig.width=6.5, out.width="75%"}
