...
Their data are loaded below and, for this exercise, reduced to only "Food and Beverage" sales.[^loaddata]

```{r echo=TRUE, results='hide'}
sms <- read.csv("https://derekogle.com/NCGraphing/modules/Intro/supermarket_sales.csv") %>%
  filter(year==2003) %>%
