...
Their data are loaded below[^loaddata] and, for this exercise, reduced to only results for the "GreatLakes" region (i.e., `filter()`, and `type` and `year` are converted to groupings (ie., `factor()` withing `mutate()`).
