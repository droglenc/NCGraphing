...
knitr::include_graphics("Ex_ggplot2_1.JPG")
```
...
knitr::include_graphics("Ex_ggplot2_2.JPG")
```
...
knitr::include_graphics("Ex_ggplot2_3.JPG")
```
...
knitr::include_graphics("Ex_ggplot2_4.JPG")
```
...
`r chunk_reveal("scatline_yr2a",break_type="auto",left_assign=leftAssign,split=splitPerc)`
...
`r chunk_reveal("scatline_yr3a",break_type="auto",left_assign=leftAssign,split=splitPerc)`
...
`r chunk_reveal("scatline_yr5b",break_type="user",left_assign=leftAssign,split=splitPerc)`

---

`r chunk_reveal("scatline_yr5c",break_type="user",left_assign=leftAssign,split=splitPerc)`
