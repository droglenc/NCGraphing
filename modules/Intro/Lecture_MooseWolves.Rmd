...
knitr::include_graphics("zimgs/Ex_ggplot2_1.JPG")
```
...
knitr::include_graphics("zimgs/Ex_ggplot2_2.JPG")
```
...
knitr::include_graphics("zimgs/Ex_ggplot2_3.JPG")
```
...
knitr::include_graphics("zimgs/Ex_ggplot2_4.JPG")
```
...
.center[
```{r, echo=FALSE, out.width="500px"}
knitr::include_graphics("zimgs/wolves_moose.jpg")
```
